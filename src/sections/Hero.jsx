  ...
  return (
    ...
    min-h-screen gap-10 max-container ">
      ...
      max-xl:padding-x pt-28">
        <p className="text-xl font-montserrat text-coral-red">Mber season is here</p>
        <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82px] font-bold">
          <span className="xl:bg-white xl:whitespace-nowrap relative z-10 pr-10">The mber month arrival</span>
          <br/>
          <span className="text-coral-red inline-block mt-3">Paschal </span>  Shoes
          </h1>
